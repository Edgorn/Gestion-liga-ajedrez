 ...
 * @author edgar
 */
public class JFrameAdminGerentes extends javax.swing.JFrame {
    ...
    public JFrameAdminGerentes(JFrame f, LigaAjedrez la) {
        initComponents();
        frame = f;
        liga = la;
    }
    ...
    private void initComponents() {
        ...
        jListGerentes = new javax.swing.JList<>();
        ...
        jListGerentes.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jScrollPane1.setViewportView(jListGerentes);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        JFrameEditGerentes gerente = new JFrameEditGerentes(this, liga);
        this.setVisible(false);
        gerente.setVisible(true);
    }//GEN-LAST:event_jButtonNuevoActionPerformed

    private void jButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarActionPerformed
        if (jListGerentes.getSelectedValue() != null) {
            liga.setGerenteActual(jListGerentes.getSelectedValue());
            JFrameEditGerentes gerente = new JFrameEditGerentes(this, liga);
            this.setVisible(false);
            gerente.setVisible(true);
        }
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        if (jListGerentes.getSelectedValue() != null) {
            liga.eliminarGerente(jListGerentes.getSelectedValue());
            anyadirGerentes();
        }
    }//GEN-LAST:event_jButtonEliminarActionPerformed

    private void anyadirGerentes(){
        ArrayList<String> gerentes = liga.listaGerentes();
        String [] lista = new String[gerentes.size()];
        jListGerentes.setListData(lista);
        
        for(int i=0;i<gerentes.size();i++)
            lista[i]=gerentes.get(i);
        jListGerentes.setListData(lista);
    }
    ...
    private javax.swing.JList<String> jListGerentes;
